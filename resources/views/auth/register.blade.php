                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="{{ route('register.save') }}" method="POST" class="user">
                                @csrf
                                ...
                                <div class="form-group row">
                                  ...
                                  <div>
                                    <input name="password_confirmation" type="password" class="form control form-control-user @error('password_confirmation')is-invalid @enderror" id="exampleInputPassword_Confirmation" placeholder="Password_Confirmation">
